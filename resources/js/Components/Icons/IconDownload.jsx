...
export default function IconDownload({ className = '', fill = 'currentColor', ...props }) {
    return (
        <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={fill} className={'size-6 ' + className}>
