...
const SettingsVoice = ({ isOpen, handleClose, fixStability, fixSimilarity, fixStyle, fixSpeakerBoost }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-gray-600 bg-opacity-50 flex justify-center items-center">
            <form>
                <div className="bg-gradient-to-r from-white to-pink-300 p-6 rounded-lg shadow-lg w-96 relative">
                    <button type='button' onClick={handleCloseAndReset} className='absolute top-4 right-5 !shadow-none transform-none rounded-none'>
