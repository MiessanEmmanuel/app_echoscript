            ...
            <header className="lg:block hidden fixed left-0 top-0 h-full w-[4em] z-[41] p-3 backdrop-blur-xl  border-drop bg-white/60  " id="header-Normal">
                <nav className="flex flex-col justify-between  h-full">
                    <div className="flex-1 flex flex-col space-y-6" id="logopng">
                        ...
                        <div className="backdrop-blur-xl  border-drop bg-white/60  rounded-lg p-2 font-bold">
                    ...
                    <div className="flex-1 flex flex-col justify-end  mb-8 mt-auto space-y-6">
                       ...
                       {/*<div className="bg-white-blue rounded-full p-5 bottom-0 text-center " style="box-sizing: border-box;">
            ...
            <div className="flex flex-col justify-between  h-full">
                ...
                <div className="flex-1 flex flex-col space-y-6 text-sm" id="logopng">
                    ...
                    <a href="{/*route('history')*/}"
                        className="backdrop-blur-xl  border-drop bg-white/60 !bg-none rounded-lg p-2  hover:bg-white-blue flex items-center space-x-2 active ">
                        <span href="/">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1.1rem" height="1.1rem" fill="none"
                                viewBox="0 0 24 24">
                    ...
                    <a href="{/*route('payouts')*/}"
                        className="backdrop-blur-xl  border-drop bg-white/60 !bg-none rounded-lg p-2 hover:bg-white-blue flex items-center space-x-2 ">
                        <span >
