...
class PagesController extends Controller
{
    ...
    public function showHistory()
    {
        ...
        $histories = Transcribedaudio::where('id_user', Auth::id())->get();
        foreach ($histories as $key => $history) {
            //remplacer le code de la history->voice par son nom reel correspondant present dans $voices
            $histories[$key]->voice = array_search($history->voice, $voices);
            $history->url_transcribed_audio = 'https://appechoscript.s3.eu-north-1.amazonaws.com/' . $history->url_transcribed_audio;
        }
    ...
    public function showHomeProject()
    {
        ...
        foreach ($projects as $key => $project) {
            //remplacer le code de la history->voice par son nom reel correspondant present dans $voices
            $projects[$key]->default_voice = array_search($project->default_voice, $voices);
        }
    ...
    public function showConfigVoiceParameter(Request $request)
    {
        $voices = array(
            "Adam" => "pNInz6obpgDQGcFmaJgB",
            "Antoni" => "ErXwobaYiN019PkySvjV",
        ...
        return Inertia::render('project/ConfigVoiceParameter', [
            'voices' => $voices,
            'project' => $project
        ]);
    }
